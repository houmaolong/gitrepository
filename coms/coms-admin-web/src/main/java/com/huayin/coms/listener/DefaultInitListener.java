 ...
 */
package com.huayin.coms.listener;
...
public class DefaultInitListener implements ServletContextListener
{
	...
	private void initRootConfigPath(ServletContext sc)
	{
		...
		// 初始化配置文件根目录
		/**********************************
		 * 常用服务器缺省存放配置文件根目录： TOMCAT：$TOMCAT_HOME/bin/config OC4J: $OC4J_HOME/j2ee/home/sims/config
		 **********************************/
		// 首先从系统属性中读取
	...
	private void intiLogBack(ServletContext sc)
	{
		...
		try
		{
			logbackFile = getUserDir() + "/config/logback/logback.xml";
